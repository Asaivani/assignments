...
console.log(passwordStrength("Hel"));
...
console.log(firstInDictionary("rhino", "aardvark", "zebra"));
...
console.log(getTagName("<p>this is a paragraph</div>"));
...
console.log(isQuestion("who are you?"));
...
var magic8Ball = function (str) {
	var arr=["very doubtfull","My reply is no","My reply is yes"];
	if(isQuestion(str))
	{
...
var interjectAt = function (str1,n,str2) {
	return str2.slice(0,n)+"-"+str1+"-"+str2.slice(n);
};
console.log(interjectAt("hello",5,"welcome"));
...
var randomInterject = function (str1,str2) {
	var n=Math.floor(Math.random()*str2.length);
	return interjectAt(str1,n,str2);
};
console.log(randomInterject("hai","You are beautifull"));
