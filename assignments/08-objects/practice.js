...
var isUser = function (obj) {
	...
	if(typeof(obj)=="object"){
		var x=Object.keys(obj).every(function(arg){
...
var userWithTweetsToDiv = function(obj){
	if(obj.tweets.length==2){
	return "<div><h1>"+obj.name+"</h1><h2>"+obj.screen_name+"</h2><ul><li>"+obj.tweets[0]+"</li><li>"+obj.tweets[1]+"</li></ul></div>"
}
};
